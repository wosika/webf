...
class WebFInfo {
  ...
  String get appName {
    if (_nativeWebFInfo.ref.appName == nullptr) return '';
    return _nativeWebFInfo.ref.appName.toDartString();
  }

  String get appVersion {
    if (_nativeWebFInfo.ref.appVersion == nullptr) return '';
    return _nativeWebFInfo.ref.appVersion.toDartString();
  }
  ...
  String get systemName {
    if (_nativeWebFInfo.ref.systemName == nullptr) return '';
    return _nativeWebFInfo.ref.systemName.toDartString();
  }
}
  ...
  if (QuickJSByteCodeCacheObject.cacheMode == ByteCodeCacheMode.DEFAULT &&
    ...
    try {
      ...
      if (QuickJSByteCodeCache.isCodeNeedCache(codeBytes)) {
        ...
        _evaluateScripts(_allocatedPages[contextId]!, codePtr, codeBytes.length, nullptr, nullptr, urlPtr, line,
            scriptElementPtr, context, resultCallback);
      }
      return completer.future;
    } catch (e, stack) {
